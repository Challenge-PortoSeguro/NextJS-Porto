    ...
    return (
        <main className="container-register">
            ...
            <div className="register">
                <h1>{!nextStep ? "Cadastro Colaborador" : "Cadastro do Modal"}</h1>
                <form>
                    {!nextStep && (
                        <>
                    ...
                    {nextStep && (
                        <>
                            ...
                            <div className="two-inputs">
                                ...
                                <Input label="Nº Eixo" type="text" placeholder="Digite o Nº do eixo" />
                            </div>
                            <div className="two-inputs">
                            ...
                            <div className="div-buttons">
                                ...
                                <ButtonSuccess type="submit" onClick={() => handleRegister()}>Cadastrar</ButtonSuccess>
                            </div>
                        </>
                    )}
                </form>
